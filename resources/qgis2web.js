...
map.getView().fit([-7885753.609090, -8117687.538769, 27235670.028032, 10801494.439341], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">QGIS2web test</h2>';
        return titleElement;
    })(),
